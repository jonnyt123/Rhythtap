...
const SONGS=`,
 ...
 {id:'through-fire-flames',title:'Through the Fire and Flames',artist:'DragonForce',bpm:198.8,color:'#ff6f2d',root:0,progression:[],melody:[],unlockLevel:5,duration:300.121,audioFile:'audio/through-fire-and-flames.mp3',previewFile:'audio/through-fire-and-flames.mp3',charts:beatCharts(198.8,1324,300.121,3)}`;

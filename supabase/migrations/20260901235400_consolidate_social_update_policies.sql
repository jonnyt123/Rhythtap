...
drop policy if exists "Friend participants can transition pending status" on public.player_friend_requests;
...
drop policy if exists "Invite participants can transition pending status" on public.battle_invites;

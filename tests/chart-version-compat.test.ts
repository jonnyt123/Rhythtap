...
Deno.test('missing chart version remains v3 for existing clients',()=>{if(normalizeChartVersion(undefined)!==3)throw new Error('missing chart version must default to v3');if(normalizeChartVersion(3)!==3)throw new Error('v3 must remain v3');if(normalizeChartVersion(4)!==4)throw new Error('v4 must opt in explicitly')});
